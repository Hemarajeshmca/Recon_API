	...
	public class themedata
	{
		...
		public DataTable themeReaddata(UserManagementModel.headerValue headerval, themelistmodel list, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message + "Param:" + JsonConvert.SerializeObject(list), "pr_get_themelist", headerval.user_code, constring);
				return result;
			}
		}
		public DataTable themeHeaderdata(themeHeadermodel Objmodel, UserManagementModel.headerValue headerval, string constring)
		{
			try
			{
				...
				parameters.Add(dbManager.CreateParameter("in_theme_query", Objmodel.themequery, DbType.String));
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message + "Param:" + JsonConvert.SerializeObject(Objmodel), "pr_recon_mst_ttheme", headerval.user_code, constring);
				return result;
			}
		}
		...
		public DataTable themedetaildata(themedetailmodel Objmodel, UserManagementModel.headerValue headerval, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message + "Param:" + JsonConvert.SerializeObject(Objmodel), "pr_recon_mst_tthemefield", headerval.user_code, constring);
				return result;
			}
		}
		...
		public DataSet themedetaildatafetch(themeDetailmodelfetch themeDetailmodel,UserManagementModel.headerValue headerval, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message + "Param:" + JsonConvert.SerializeObject(themeDetailmodel), "pr_get_themefield", headerval.user_code, constring);
				return ds;
			}
		}
		...
		public DataTable ThemeConditionData(ThemeCondition objthemeCondition, UserManagementModel.headerValue headerval, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message + "Param:" + JsonConvert.SerializeObject(objthemeCondition), "pr_recon_mst_tthemecondition", headerval.user_code, constring);
				return result;
			}
		}
		public DataTable themegroupingData(themegrouping objthemegrouping, UserManagementModel.headerValue headerval, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message + "Param:" + JsonConvert.SerializeObject(objthemegrouping), "pr_recon_mst_tthemegrpfield", headerval.user_code, constring);
				return result;
			}
		}
		...
		public DataTable themeaggfunData(Aggfunction objAggfunction, UserManagementModel.headerValue headerval, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message + "Param:" + JsonConvert.SerializeObject(objAggfunction), "pr_recon_mst_tthemeaggfun", headerval.user_code, constring);
				return result;
			}			
		}
		public DataTable getConditioncriteriaData(getConditiontheme objcondition, UserManagementModel.headerValue headerval, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message + "Param:" + JsonConvert.SerializeObject(objcondition), "pr_get_conditiontheme", headerval.user_code, constring);
				return result;
			}
		}
		public DataTable themeaggconditionData(Aggcondition objAggcondition, UserManagementModel.headerValue headerval, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message + "Param:" + JsonConvert.SerializeObject(objAggcondition), "pr_recon_mst_tthemeaggcon", headerval.user_code, constring);
				return result;
			}
		}
		...
		public DataTable themelistclonedata(UserManagementModel.headerValue headerval, themelistmodel list, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message + "Param:" + JsonConvert.SerializeObject(list), "pr_get_themelistclone", headerval.user_code, constring);
				return result;
			}
		}
		public DataTable clonethemeData(clonethemeModel objclonetheme, UserManagementModel.headerValue headerval, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message + "Param:" + JsonConvert.SerializeObject(objclonetheme), "pr_clone_theme", headerval.user_code, constring);
				return result;
			}
		}
