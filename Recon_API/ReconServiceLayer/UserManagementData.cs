    ...
    public class UserManagementData
    {
        ...
        public DataTable Loginvalidation(Login_model Objmodel, string constring)
        {
            ...
            catch (Exception ex)
            {
				...
				objlog.commonDataapi("", "SP", ex.Message, "pr_get_loginvalidation_new", Objmodel.user_id, constring);
                return result;
            }
        }
		...
		public DataTable changepass_save(change_password Usermodel, headerValue hv, string constring)
        {
            ...
            catch (Exception ex)
            {
				...
				objlog.commonDataapi("", "SP", ex.Message, "pr_set_password", hv.user_code, constring);
				throw ex;
            }
        }
        ...
        public DataSet dashboardData(dashboardmodel objdashboard, headerValue hv, string constring)
        {
            ...
            catch (Exception ex)
            {
				...
				objlog.commonDataapi("", "SP", ex.Message, "pr_get_dashboard", hv.user_code, constring);
				throw ex;
            }
        }
		...
		public List<treeviewllist> treeviewlist_db(headerValue Objmodel, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message, "GetTreeNodes", Objmodel.user_code, constring);
				return objList;
			}
		}
		...
		public DataTable Usersave_db(User_model Usermodel, headerValue hv, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message, "pr_ins_user", Usermodel.user_code, constring);
				throw ex;
			}
		}
		...
		public DataTable Usermappingsave_db(usermappingmodel Usermodel, headerValue hv, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message, "pr_ins_userlevelmapping", Usermodel.user_code, constring);
				throw ex;
			}
		}
		public DataTable getcheckednode_db(getcheckedmodel Usermodel, headerValue hv, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message, "pr_get_checkedvalues", Usermodel.user_code, constring);
				throw ex;
			}
		}
		public DataTable setcontextlist_db(getcheckedmodel Usermodel, headerValue Objmodel, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message, "pr_get_headers", Usermodel.user_code, constring);
				return result;
			}
		}
		public DataTable applycontextlist_db(setcontextmodel Usermodel, headerValue Objmodel, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message, "pr_ins_usercontext", Usermodel.user_code, constring);
				return result;
			}
		}
		public DataTable getcontextlist_db(getcontexttmodel Usermodel, headerValue Objmodel, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message, "pr_fetch_getcontext", Usermodel.user_code, constring);
				return result;
			}
		}
		public DataSet getmenulist_db(getmenumodel menumodel, headerValue Objmodel, string constring)
		{
			...
			catch (Exception ex)
			{
				...
				objlog.commonDataapi("", "SP", ex.Message, "pr_getmenu", menumodel.user_code, constring);
				return ds;
			}
		}
