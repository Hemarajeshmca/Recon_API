...
namespace ReconDataLayer
{
    public class MastersData
    {
        ...
        public DataSet Reconfiletemplate(Reconfiletemplate reconfiletemplate)
        {
            ...
            {
                CommonHeader objlog = new CommonHeader();
                objlog.logger("SP:pr_recon_mst_treconfiletemplate" + "Error Message:" + ex.Message);
                throw ex;
            }
        ...
        public DataSet Mstrule(Mstrule mstrule)
        {
            ...
            {
                CommonHeader objlog = new CommonHeader();
                objlog.logger("SP:pr_recon_mst_trule" + "Error Message:" + ex.Message);
                throw ex;
            }
        ...
        public DataSet Filetemplatefield(Filetemplatefield filetemplatefield)
        {
            ...
            {
                CommonHeader objlog = new CommonHeader();
                objlog.logger("SP:pr_recon_mst_tfiletemplatefield" + "Error Message:" + ex.Message);
                throw ex;
            }
        ...
        public DataSet Filetemplate(Filetemplate filetemplate)
        {
            ...
            {
                CommonHeader objlog = new CommonHeader();
                objlog.logger("SP:pr_recon_mst_tfiletemplate" + "Error Message:" + ex.Message);
                throw ex;
            }
        ...
        public DataSet Rulefield(Rulefield rulefield)
        {
            ...
            {
                CommonHeader objlog = new CommonHeader();
                objlog.logger("SP:pr_recon_mst_trulefield" + "Error Message:" + ex.Message);
                throw ex;
            }
        }
        ...
        public DataSet Applyrule(Applyrule applyrule)
        {
            ...
            {
                CommonHeader objlog = new CommonHeader();
                objlog.logger("SP:pr_recon_mst_tapplyrule" + "Error Message:" + ex.Message);
                throw ex;
            }
        ...
        public DataSet Applyruledtl(Applyruledtl applyruledtl)
        {
            ...
            {
                CommonHeader objlog = new CommonHeader();
                objlog.logger("SP:pr_recon_mst_tapplyruledtl" + "Error Message:" + ex.Message);
                throw ex;
            }
        ...
        public DataSet Applyrule_addcond(Applyrule_addcond applyruleaddcond)
        {
            ...
            {
                CommonHeader objlog = new CommonHeader();
                objlog.logger("SP:pr_recon_mst_tapplyrule_addcond" + "Error Message:" + ex.Message);
                throw ex;
            }
        ...
        public DataSet Applyrule_targetgrpfield(Applyrule_targetgrpfield applyruletargetgrpfield)
        {
            ...
            {
                CommonHeader objlog = new CommonHeader();
                objlog.logger("SP:pr_recon_mst_tapplyrule_targetgrpfield" + "Error Message:" + ex.Message);
                throw ex;
            }
        ...
        public DataSet Applyrule_basesele(Applyrule_basesele applyrulebasesele)
        {
            ...
            {
                CommonHeader objlog = new CommonHeader();
                objlog.logger("SP:pr_recon_mst_tapplyrule_basesele" + "Error Message:" + ex.Message);
                throw ex;
            }
        ...
        public DataSet Applyrule_basefilter(Applyrule_basefilter applyrulebasefilter)
        {
            ...
            {
                CommonHeader objlog = new CommonHeader();
                objlog.logger("SP:pr_recon_mst_tapplyrule_basefilter" + "Error Message:" + ex.Message);
                throw ex;
            }
