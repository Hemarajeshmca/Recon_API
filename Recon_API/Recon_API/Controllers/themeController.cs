...
namespace Recon_API.Controllers
{
	...
	public class themeController : ControllerBase
	{
		...
		[HttpPost("themeHeader")]
		public IActionResult themeHeader(themeHeadermodel themeHeadermodel)
		{
			constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
			headerValue header_value = new headerValue();
			DataTable response = new DataTable();
			try
			{
				...
				header_value.lang_code = getlangCode;
				header_value.role_code = getRoleCode;
				response = theme_service.themeHeader(themeHeadermodel, header_value, constring);
				var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
				return Ok(serializedProduct);
			}
			catch (Exception e)
		...
		[HttpPost("getdataagainsRecontheme")]
		public IActionResult getdataagainsRecontheme(getdataagainsRecon objdatarecon)
		{
			constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
			headerValue header_value = new headerValue();
			DataTable response = new DataTable();
			try
			{
				...
				header_value.lang_code = getlangCode;
				header_value.role_code = getRoleCode;
				response = theme_service.getdataagainsReconthemesrv(objdatarecon, header_value, constring);
				var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
				return Ok(serializedProduct);
			}
			catch (Exception e)
		...
		[HttpPost("themelistclone")]
		public IActionResult themelistclone(themelistmodel list)
		{
			constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
			headerValue header_value = new headerValue();
			DataTable response = new DataTable();
			try
			{
				...
				header_value.lang_code = getlangCode;
				header_value.role_code = getRoleCode;
				response = theme_service.themelistclonesrv(header_value, list, constring);
				var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
				return Ok(serializedProduct);
			}
			catch (Exception e)
		...
		[HttpPost("clonetheme")]
		public IActionResult clonetheme(clonethemeModel objclonetheme)
		{
			constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
			headerValue header_value = new headerValue();
			DataTable response = new DataTable();
			try
			{
				...
				header_value.lang_code = getlangCode;
				header_value.role_code = getRoleCode;
				response = theme_service.clonethemeService(objclonetheme, header_value, constring);
				var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
				return Ok(serializedProduct);
			}
			catch (Exception e)
