...
namespace Recon_API.Controllers
{
	...
	public class UpdateReconController : ControllerBase
	{
        ...
        [HttpPost("datasetmap")]
        public IActionResult datasetmap(datasetmapModel objdatasetmap)
        {
            constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
            headerValue header_value = new headerValue();
            DataTable response = new DataTable();
            try
            {
                ...
                header_value.lang_code = getlangCode;
                header_value.role_code = getRoleCode;
                response = UpdateReconService.datasetmapService(objdatasetmap, header_value, constring);
                var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
                return Ok(serializedProduct);
            }
            catch (Exception e)
		...
		[HttpPost("datasetlistmapped")]
		public IActionResult datasetlistmapped(datasetlistmappedModel objdatasetlistmapped)
		{
			constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
			headerValue header_value = new headerValue();
			DataTable response = new DataTable();
			try
			{
				...
				header_value.lang_code = getlangCode;
				header_value.role_code = getRoleCode;
				response = UpdateReconService.datasetlistmappedService(objdatasetlistmapped, header_value, constring);
				var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
				return Ok(serializedProduct);
			}
			catch (Exception e)
        ...
        [HttpPost("reconalllist")]
        public IActionResult reconalllist(Reconalllistmodel objReconalllist)
        {
            constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
            headerValue header_value = new headerValue();
            DataTable response = new DataTable();
            try
            {
                ...
                header_value.lang_code = getlangCode;
                header_value.role_code = getRoleCode;
                response = UpdateReconService.reconalllistService(objReconalllist, header_value, constring);
                var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
                return Ok(serializedProduct);
            }
            catch (Exception e)
        ...
        [HttpPost("ReconUpdatecusrpt")]
        public IActionResult ReconUpdatecusrpt(ReconUpdatecusrptModel objReconalllist)
        {
            constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
            headerValue header_value = new headerValue();
            DataTable response = new DataTable();
            try
            {
                ...
                header_value.lang_code = getlangCode;
                header_value.role_code = getRoleCode;
                response = UpdateReconService.ReconUpdatecusrptService(objReconalllist, header_value, constring);
                var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
                return Ok(serializedProduct);
            }
            catch (Exception e)
