	...
	public class DatasetController : ControllerBase
	{
		...
		public IActionResult getaccbaldataset(getaccbaldatasetModel objgetaccbaldataset)
		{
			...
			try
			{
				...
				header_value.lang_code = getlangCode;
				header_value.role_code = getRoleCode;
				response = DatasetService.getaccbaldatasetService(objgetaccbaldataset, header_value, constring);
				var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
				return Ok(serializedProduct);
			}
			catch (Exception e)
		...
		public IActionResult setAccountbalance(setAccountbalanceModel objsetAccountbalance)
		{
			...
			try
			{
				...
				header_value.lang_code = getlangCode;
				header_value.role_code = getRoleCode;
				response = DatasetService.setAccountbalanceService(objsetAccountbalance, header_value, constring);
				var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
				return Ok(serializedProduct);
			}
			catch (Exception e)
        ...
        [HttpPost("Datasetindex")]
        public IActionResult Datasetindex(Datasetindexmodel Datasetindexmodel)
        {
            constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
            headerValue header_value = new headerValue();
            DataTable response = new DataTable();
            try
            {
                ...
                header_value.lang_code = getlangCode;
                header_value.role_code = getRoleCode;
                response = DatasetService.Datasetindexsrv(Datasetindexmodel, header_value, constring);
                var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
                return Ok(serializedProduct);
            }
            catch (Exception e)
        ...
        [HttpPost("Datasetindexlist")]
        public IActionResult Datasetindexlist(Datasetindexlist Datasetindexmodel)
        {
            constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
            headerValue header_value = new headerValue();
            DataTable response = new DataTable();
            try
            {
                ...
                header_value.lang_code = getlangCode;
                header_value.role_code = getRoleCode;
                response = DatasetService.Datasetindexlistsrv(Datasetindexmodel, header_value, constring);
                var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
                return Ok(serializedProduct);
            }
            catch (Exception e)
