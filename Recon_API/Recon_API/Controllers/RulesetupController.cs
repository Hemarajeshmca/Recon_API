...
namespace Recon_API.Controllers
{
    ...
    public class RulesetupController : ControllerBase
    {
		...
		[HttpPost("cloneReconRule")]
		public IActionResult cloneReconRule(cloneReconRuleModel objcloneReconRule)
		{
			constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
			headerValue header_value = new headerValue();
			DataTable response = new DataTable();
			try
			{
				...
				header_value.lang_code = getlangCode;
				header_value.role_code = getRoleCode;
				response = RulesetupService.cloneReconRuleService(objcloneReconRule, header_value, constring);
				var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
				return Ok(serializedProduct);
			}
			catch (Exception e)
		...
		[HttpGet("getAllRuleList")]
		public IActionResult getAllRuleList()
		{
			constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
			headerValue header_value = new headerValue();
			DataTable response = new DataTable();
			try
			{
				...
				header_value.lang_code = getlangCode;
				header_value.role_code = getRoleCode;
				response = RulesetupService.getAllRuleListService(header_value, constring);
				var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
				return Ok(serializedProduct);
			}
			catch (Exception e)
        ...
        [HttpPost("getdatasetField")]
        public IActionResult getdatasetField(getdatasetFieldModel objgetdatasetField)
        {
            constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
            headerValue header_value = new headerValue();
            DataTable response = new DataTable();
            try
            {
                ...
                header_value.lang_code = getlangCode;
                header_value.role_code = getRoleCode;
                response = RulesetupService.getdatasetFieldService(objgetdatasetField, header_value, constring);
                var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
                return Ok(serializedProduct);
            }
            catch (Exception e)
        ...
        [HttpPost("getDSCondition")]
        public IActionResult getDSCondition(getDSConditionModel objgetDSCondition)
        {
            constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
            headerValue header_value = new headerValue();
            DataTable response = new DataTable();
            try
            {
                ...
                header_value.lang_code = getlangCode;
                header_value.role_code = getRoleCode;
                response = RulesetupService.getDSConditionService(objgetDSCondition, header_value, constring);
                var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
                return Ok(serializedProduct);
            }
            catch (Exception e)
        ...
        [HttpPost("fetchrule_new")]
        public IActionResult fetchrule_new(fetchRule objfetchrule)
        {
            constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
            headerValue header_value = new headerValue();
            DataSet response = new DataSet();
            try
            {
                ...
                header_value.lang_code = getlangCode;
                header_value.role_code = getRoleCode;
                response = RulesetupService.Rulefetch_new(objfetchrule, header_value, constring);
                var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
                return Ok(serializedProduct);
            }
            catch (Exception e)
